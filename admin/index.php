...
<?php require_once('inc/header.php') ?>
  <body class="layout-fixed control-sidebar-slide-open layout-navbar-fixed" data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper" style="background-image: url(../admin/inc/bg_cards.jpg); background-size: cover; background-position: center; background-repeat: no-repeat;">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
      ...
      <div class="content-wrapper pt-3" style="min-height: 567.854px;">
        ...
        <!-- Main content -->
        <section class="content" style="background-image: url(../admin/inc/bg_cards.jpg); background-size: cover; background-position: center; background-repeat: no-repeat;">
